            ...
            {authenticated ? (
                <>
                    <div className={classes.sectionDesktop}>
                        <div className={classes.content}>
                            ...
                            <Grid container className={`stickyPaper ${classes.grid}`}>
                                ...
                                <Grid item className={classes.gridItem} lg={4} md={4} sm={4}>
                    ...
                    <div className={classes.sectionMobile}>
                        <div className={`appear ${classes.mobileContent}`}>
                            <div>
                                {this.state.profile === null ? (
                                    <>
                                        <div>
                    ...
                    <div className={classes.sectionMobileSm}>
                        <div className={classes.contentSm}>
                            <div>
                                {this.state.profile === null ? (
                                    <>
                                        <div>
                            ...
                            <Grid container className={classes.grid}>
                                <Grid item className={classes.gridItemSm} sm={12} xs={12} >
                                    { screamMarkup }
                                </Grid>
                            </Grid>
                        </div>
                ...
                <>
                    <div className={classes.sectionDesktop}>
                        <div className={classes.content2}>
                            ...
                            <Grid container className={`stickyPaper ${classes.gridNotAuth}`}>
                                <Grid item className={classes.gridItem} sm={8} xs={12} >
                                    { screamMarkup }
                                </Grid>
                                <Grid item className={classes.gridItem} lg={4} md={4} sm={null} xs={null}>
                                    {this.state.status === null ? (
                                        <Paper className={`stickyPaper ${classes.paper}`}>
                                            <div className={classes.profile}>
                                                <div className="image-wrapper">
