...
// Mui stuff
import { withStyles, Tooltip, IconButton, Dialog, DialogTitle, DialogContent, TextField, DialogActions, Box, Avatar, Button, List, /*ListItem,*/ ListItemIcon } from '@material-ui/core';
...
class EditDetailsSideNav extends Component {
    state = {
        bio: '',
        website: '',
        location: '',
...
export default connect(mapStateToProps, mapActionsToProps)(withStyles(styles)(EditDetailsSideNav))
