            ...
            <Fragment>
                <>
                    <div className={classes.sectionDesktop}>
                        <MyButton arialabel="Post a scream" onClick={this.handleOpen} tip="Post a scream!">
                    ...
                    <div className={classes.sectionMobile}>
                        <List onClick={this.handleOpen}>
                            <ListItem color="inherit" className={classes.button} button>
                                <ListItemIcon><AddIcon className={`stickyPaper ${classes.add}`}/></ListItemIcon>
                                <ListItemText className={`stickyPaper ${classes.cardText}`} primary="Post" />
                            </ListItem>
                        </List>
