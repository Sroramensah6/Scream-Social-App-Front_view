...
// MUI stuff
import { withStyles, Menu, MenuItem, Badge, Typography, List, ListItem, ListItemIcon, ListItemText } from '@material-ui/core';
                    ...
                    <div className={classes.sectionMobile}>
                        <List onClick={this.handleOpenMobile} >
                            <ListItem color="inherit" className={classes.button} button>
                                ...
                                <ListItemText className={`stickyPaper ${classes.cardText}`} primary="Notificatons" />
                            </ListItem>
                        </List>
                        {/* <MenuItem>
